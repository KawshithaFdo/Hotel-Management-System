...
public class AdminRoomAvailabilityController {
    public AnchorPane AdminRoomAvailabilityContext;

    public void TurnOFF(ActionEvent actionEvent) {
        new Alert(Alert.AlertType.CONFIRMATION, "Room Unavailabel", ButtonType.CLOSE).show();
    }
    ...
    public void GoBack(ActionEvent actionEvent) throws IOException {
        ...
        if (result.orElse(no) == yes) {
            ...
            Stage window = (Stage) AdminRoomAvailabilityContext.getScene().getWindow();
