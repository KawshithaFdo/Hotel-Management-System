...
public class MaintainForm2Controller {
    public AnchorPane MaintainContext;

    public void mamintain(ActionEvent actionEvent) {
        new Alert(Alert.AlertType.CONFIRMATION, " Room In Maintaince.", ButtonType.CLOSE).show();
    }
